package com.example.bama.qrcode.Login;
...
public class Login extends AppCompatActivity {
    ...
    private String url = "http://hendra.bambangm.com/" + "login.php";
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.trim().length() > 0 && password.trim().length() > 0) {
                    ...
                    Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content),"Kolom Tidak Boleh Kosong . .", Snackbar.LENGTH_SHORT);
                    snackbar.show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                       ...
                       // Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), jObj.getString(TAG_MESSAGE), Snackbar.LENGTH_LONG);
                       // snackbar.show();
